...
LDFLAGS= -static -fopenmp -flto -fuse-linker-plugin -O3 -pipe -Wno-unused-function -lgcov -lpthread -lz -lm -llzma -I$(cdir)/src/boost -I$(cdir)/src/htslib/include -L$(cdir)/src/htslib/lib -Wl,-rpath=$(cdir)/src/htslib/lib -I$(cdir)/src/BRENT -I$(cdir)/src/shrinkwrap/include -Wl,--no-as-needed
