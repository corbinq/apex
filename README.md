...
## Additional documentation pages
 ...
 - **[YAX xQTL summary association data file formats](/doc/sumstat_files)** generated by `yax store` and used in `yax meta`. 
 - **[Bayesian finemapping using YAX xQTL summary association data files](/doc/example_finemapping)** generated by `yax store`. 
