...
We have conducted extensive benchmarking and simulation experiments to ensure that YAX is accurate, efficient, scalable for both small and large sample sizes. For more information, [**see benchmarking page.**](benchmarking.md)
...
## Analysis modes and documentation
 - [**cis-xQTL analysis.**](mode_cis.md) `./yax cis {options}`
...
## Additional documentation pages
 ...
 - **[Input file formats for individual-level analysis](input_files.md)** in modes `yax cis`, `yax trans`, and `yax store`. 
 - **[YAX xQTL summary association data file formats](sumstat_files.md)** generated by `yax store` and used in `yax meta`. 
 - **[Bayesian finemapping using YAX xQTL summary association data files](example_finemapping.md)** generated by `yax store`. 
